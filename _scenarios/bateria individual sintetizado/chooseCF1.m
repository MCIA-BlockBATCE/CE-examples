function [Dec1, bid_case, MaxDishargingPowerForParticipantIfBid] = chooseCF1(TimeHorizonToBid, SoC_energy_CER, BidAmount, t, BidStep, ...
    ...
    price_next_1h, selling_price, price_next_3h, SoC, price_next_6h, MaxDishargingPowerForParticipant, n)
...
if ( (t >= BidStep - TimeHorizonToBid*(1/TimeStep)) && t < BidStep + OneHour )
   [Dec1, MaxDishargingPowerForParticipantIfBid] = CF1_Interoperability(SoC_energy_CER(t),BidAmount,t,BidStep,PconsForecast3h(t,n),PconsForecast1h(t,n),Pgen_pred_3h_allocated(t,n), ...
                 Pgen_pred_1h_allocated(t,n),price_next_1h(t,1),selling_price(t,1),price_next_3h(t,1),SoC(t,n),price_next_6h(t,1),MaxDishargingPowerForParticipant(1,n));
   bid_case = 1;
