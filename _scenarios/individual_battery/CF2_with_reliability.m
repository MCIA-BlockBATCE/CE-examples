function FCoste2 = CF2_with_reliability(ConsPred3h,ConsPred1h,GenPred3h,GenPred1h,Energy_price, ...
    Energy_price3h,Energy_price6h,SoC,reliability)
...
% Additionally, the reliability metric is taken into account, in order to
% save the stored energy only if prediction can be trusted
