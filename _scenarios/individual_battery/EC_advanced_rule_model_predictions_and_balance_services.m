...
for t=1:SimulationSteps
        ...
        if EnergyStorageMaximumForParticipant(1,n)>0 && SoC(t,n)>0
            ...
            if PconsMeasured(t,n)<MaxDischargingPowerForParticipant(1,n)
                ...
                if BatteryManagementDecision(t,n)==1
                    ...
                    StepEnergyDecisionIndividual(t,3)=StepEnergyDecisionIndividual(t,3)+(PconsMeasured(t,n)*TimeStep)/DischargeEfficiency;
        ...
        if Pgen_real_allocated(t,n)>PconsMeasured(t,n)
            ...
            if EnergyStorageMaximumForParticipant(1,n)>0 && SoC(t,n)<100
                ...
                % power and selling the rest to the grid.               
                    ...
                    StepEnergyDecisionIndividual(t,1)=StepEnergyDecisionIndividual(t,1)+(PowerSurplus(t,n)-MaxChargingPowerForParticipant(1,n)/ChargeEfficiency)*TimeStep;
                end
            ...
            % all surplus has to be sold to the grid            
                ...
                StepEnergyDecisionIndividual(t,1)=StepEnergyDecisionIndividual(t,1)+PowerSurplus(t,n)*TimeStep;
            end
            ...
            if EnergyStorageMaximumForParticipant(1,n)>0 && SoC(t,n)>0
                ...
                if PowerShortage(t,n)<MaxDischargingPowerForParticipant(1,n)
                    ...
                    if BatteryManagementDecision(t,n) == 1
                        ...
                        StepEnergyDecisionIndividual(t,3)=StepEnergyDecisionIndividual(t,3)+(PowerShortage(t,n)*TimeStep)/DischargeEfficiency;
    ...
    elseif PVPowerManagementDecision(t,n) == 2
        ...
        % sold to the grid
            ...
            StepEnergyDecisionIndividual(t,1)=StepEnergyDecisionIndividual(t,1)+(Pgen_real_allocated(t,n)-MaxChargingPowerForParticipant(1,n)/ChargeEfficiency)*TimeStep;
        end
